...
class main:
    def __init__(self):
        ...
        sql = 'select "//section/div[1]/div[2]/div/div/div/div[1]/span/span","//section/div[1]/div[2]/div/div/div/h1/text()" from html where url in ("https://www.lttstore.com/products/ltt-stealth-hoodie","https://www.lttstore.com/products/cpu-deconstructed-t-shirt") and selector=xpath'
        ...
        # sql='select "/html/body/div[6]/main/div[3]/section/div[1]/div/div/div/div/div/a/@href" from html where url in ("https://www.lttstore.com") and selector=xpath'
